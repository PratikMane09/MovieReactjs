...
function Upcomming() {
  ...
  // https://api.themoviedb.org/3/movie/upcomming?api_key=367dd760d5769cd24b8242911b782852&language=en-US&page=1
  //API Shows the this output
  // {
  //   "success": false,
  //   "status_code": 6,
  ...
  // }
  const apiUrl =
    "https://api.themoviedb.org/3/movie/upcoming?api_key=367dd760d5769cd24b8242911b782852&language=en-US&page=1";
  useEffect(() => {
